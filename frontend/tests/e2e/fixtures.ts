  ...
  decisions: [
    {
      ...
      rationale: "RS composite crossed 7.0 threshold — strong relative strength",
      confidence: "0.82",
      horizon: "medium_term",
      horizon_end_date: "2026-07-11",
      status: "active",
      source_agent: "rs-analyzer",
    ...
    },
    {
      ...
      entity_type: "equity",
      decision_type: "avoid",
      rationale: "RS momentum negative, below 200 DMA",
      confidence: "0.71",
      horizon: "short_term",
      horizon_end_date: "2026-05-11",
      status: "active",
      source_agent: "sector-analyst",
      created_at: "2026-04-11T08:30:00+05:30",
      user_action: "IGNORED",
      user_action_at: "2026-04-11T10:00:00+05:30",
      user_notes: null,
    },
  ],
  meta: { data_as_of: "2026-04-11", record_count: 2, query_ms: 8, stale: false },
};

export const FINDINGS_FIXTURE: FindingsListResponse = {
  findings: [
    {
      id: "fin-001",
      agent_id: "rs-analyzer-v1",
      agent_type: "rs_analyzer",
      entity: "HDFCBANK",
      entity_type: "equity",
      finding_type: "rs_analysis",
      title: "RS Composite 7.1 — LEADING",
      content: "HDFCBANK RS composite of 7.1 places it firmly in LEADING quadrant vs NIFTY 500",
      confidence: "0.85",
      tags: ["leading", "rs", "banks"],
      data_as_of: "2026-04-11T00:00:00+05:30",
      created_at: "2026-04-11T06:00:00+05:30",
    },
    {
      id: "fin-002",
      agent_id: "sector-analyst-v1",
      agent_type: "sector_analyst",
      entity: "HDFCBANK",
      entity_type: "equity",
      finding_type: "sector_analysis",
      title: "Banks sector leading",
      content: "Banks sector is in LEADING quadrant with avg RS 6.2; HDFCBANK outperforms peers",
      confidence: "0.78",
      tags: ["sector", "banks", "leading"],
      data_as_of: "2026-04-11T00:00:00+05:30",
      created_at: "2026-04-11T06:30:00+05:30",
    },
    {
      id: "fin-003",
      agent_id: "rs-analyzer-v1",
      ...
      title: "7 of 8 technicals passing",
      content: "Strong technical setup: above 200/50 DMA, RSI healthy at 62.3, ADX trending 32.5",
      confidence: "0.80",
      tags: ["technical", "dma", "rsi"],
      data_as_of: "2026-04-11T00:00:00+05:30",
      created_at: "2026-04-11T07:00:00+05:30",
    },
  ],
  meta: { data_as_of: "2026-04-11", record_count: 3, query_ms: 12, stale: false },
};
