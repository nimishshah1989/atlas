...
def build_failure_record(
    ...
    """
    from scripts.forge_runner._time import now_ist, to_iso  # local to avoid circular
    ...
    try:
        from scripts.forge_runner.state import get_chunk  # local to avoid circular
...
def append_event_and_update_state(
    ...
    """
    from scripts.forge_runner._time import now_ist, to_iso  # local import avoids circular
