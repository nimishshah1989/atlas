...
1. **Hero strip** — "Lab · Strategy Simulation" + quick-load chips
   ("Load: Faber 10M", "Load: JT 12-1 Momentum", "Load: %>200DMA
   regime overlay")
...
| **S1-3** | Embed breadth panel into Explore · Country + Explore · Sector | 2 existing files |
...
| **S1-6** | Build Lab (`lab.html`) — config panel + results area + formula disclosure | `lab.html`, fixtures |
